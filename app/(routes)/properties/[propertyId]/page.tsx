...
const PropertyPage = () => {
  return (
    <section className="w-full mb-10 px-12 py-8 flex gap-x-0.5 justify-between max-w-[1140px] mx-auto">
        ...
        <div className="flex flex-col rounded-md p-4">
          ...
          <div className="mt-6 mb-2 ">
            ...
            <p className="text-sm text-textColor text-justify leading-[1.65]">
              ...
              serene sanctuary for those seeking comfort and convenience. Bathed
              in natural light from the large window, the room exudes a warm and
